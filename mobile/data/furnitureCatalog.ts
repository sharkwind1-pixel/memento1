...
export const FURNITURE_CATALOG: FurnitureItem[] = [
    ...
    },
    {
        ...
        name: "민트 소파",
        category: "furniture",
        imageUrl: abs("/icons/furniture/sofa_mint.png"),
        price: 160,
    ...
    },
    {
        ...
        name: "우주 방석",
        category: "furniture",
        imageUrl: abs("/icons/furniture/galaxy_bed.png"),
        price: 200,
    ...
    },
    {
        ...
        name: "담요 바구니",
        category: "furniture",
        imageUrl: abs("/icons/furniture/blanket_basket.png"),
        price: 130,
    ...
    // -- 소품 (accessory) 추가 --
    {
        ...
        name: "다육이 화분",
        category: "accessory",
        imageUrl: abs("/icons/furniture/succulent_pot.png"),
        price: 50,
    ...
    },
    {
        ...
        name: "간식 항아리",
        category: "accessory",
        imageUrl: abs("/icons/furniture/treat_jar.png"),
        price: 70,
    ...
    // 정면 평면 원근이라 작게 둬야 아이소메트릭 스테이지에서 벽 소품처럼 자연스러움.
    {
        ...
        name: "아치 창문",
        category: "window",
        imageUrl: abs("/icons/furniture/arch_window.png"),
        price: 120,
