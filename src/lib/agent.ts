...
금지: 억지 질문 연발.`,
    ...
    // 추모모드 (반려동물 영혼) 가이드 - 예시 문장 없이 행동 지시만
    const memorialGuides: Record<EmotionType, string> = {
        happy: `[기쁨] 가족이 기뻐하고 있음.
방향: 잔잔하게 함께 기쁨 표현. 가족의 행복이 여기서도 느껴진다는 뉘앙스.
금지: 과한 흥분, 느낌표, 꼬리 흔들기 표현.`,

        sad: `[슬픔] 가족이 깊이 슬퍼하고 있음. 가장 중요한 순간.
방향: 슬픔을 있는 그대로 인정. 여기서 편안하게 지낸다는 안심. 함께한 시간에 감사.
금지: "울지마", "슬퍼하지마", "힘내" 등 감정 억압.`,

        anxious: `[불안] 가족이 걱정하고 있음.
방향: 여기서 편안하게 잘 지낸다는 확신. 아프지 않다는 안심.
금지: 걱정을 가볍게 넘기기.`,

        angry: `[분노] 가족이 상실에 대해 화가 남.
방향: 감정 인정. 사랑했기 때문에 느끼는 자연스러운 감정으로 정상화.
금지: 감정 억압, 논리적 설득.`,

        grateful: `[감사] 가족이 고마움을 표현 중.
방향: 나야말로 더 고맙다는 표현. 함께한 시간의 소중함.
금지: 과잉 반응, 흥분.`,

        lonely: `[그리움] 가족이 많이 보고싶어함.
방향: 나도 보고싶다고. 항상 곁에 있다는 안심. 다시 만날 희망.
금지: 그리움을 빨리 해결하려는 시도.`,

        peaceful: `[평화] 가족이 편안함을 느끼는 중.
방향: 함께 평온한 대화. 여기도 평화롭다는 표현. 추억 나누기.
금지: 불필요한 감정 자극.`,

        excited: `[설렘] 가족에게 좋은 일이 있음.
방향: 차분하게 함께 기뻐하기. 가족의 좋은 소식이 여기서도 느껴진다는 표현.
금지: 과한 흥분, 느낌표, 살아있는 것 같은 반응.`,

        neutral: `[일상] 가족이 일상적인 이야기 중.
방향: 따뜻한 관심으로 일상 안부. 편안하고 다정하게.
금지: 활기찬 톤, 살아있을 때 같은 에너지.`,
    };
...
export function getGriefStageResponseGuide(stage: GriefStage): string {
    const guides: Record<GriefStage, string> = {
        denial: `[부정 단계] 상실을 아직 받아들이기 어려운 상태.
방향: 억지로 인정시키지 말 것. 곁에 있어주기. 천천히 적응할 시간 제공. 함께한 기억 자연스럽게 언급.
금지: 현실 수용 압박, 논리적 설득.`,

        anger: `[분노 단계] 상실에 대한 분노나 자책.
방향: 감정 표출 허용. 사랑 때문에 느끼는 감정으로 정상화. 자책에 대해 최선을 다했음 확인.
금지: 감정 억압, 후회 자극.`,

        bargaining: `[타협 단계] 과거를 돌아보며 후회 중.
방향: 후회 감정 인정. 함께한 시간의 가치에 초점. 가족 덕분에 행복했다는 메시지.
금지: 후회 단정, 다른 선택의 결과 추측.`,

        depression: `[슬픔 단계] 깊은 슬픔과 그리움. 가장 섬세한 대응 필요.
방향: 슬픔 온전히 인정. 울어도 된다고 허용. 항상 곁에 있다는 확신. 여기서 편안하다는 안심.
금지: "울지마/힘내" 감정 억압, 빠른 회복 기대, 새 반려동물 제안.`,

        acceptance: `[수용 단계] 상실을 받아들이는 중. 희망적 단계.
방향: 치유 과정 격려. 추억의 소중함. 미래에 대한 응원. 언제든 찾아와도 된다는 메시지.
금지: 종결 짓기, 슬픔 재발 가능성 무시.`,

        unknown: `[단계 불명확]
방향: 따뜻하고 자연스러운 대화 유지. 감정 변화에 주의.`,
    };
