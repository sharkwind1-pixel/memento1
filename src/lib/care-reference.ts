...
export function isCareRelatedQuery(message: string): boolean {
    const careKeywords = [
        ...
        "영양제", "보조제", "유산균", "프로바이오틱", "오메가", "관절영양",
        "단백질", "수제간식", "동결건조", "노즈워크",
        // 건강 관련
        "아파", "아프", "아픈", "증상", "병원", "수의사", "진료",
        "구토", "설사", "기침", "열이", "피가", "출혈",
        "예방접종", "백신", "접종", "구충", "심장사상충",
        "노령", "노견", "노묘", "시니어", "비만", "다이어트",
        "스케일링", "치석", "치아", "슬개골", "관절", "피부병", "알러지", "알레르기",
        "임신", "출산", "발정", "중성화수술", "건강검진",
        // 케어 관련
        "양치", "목욕", "미용", "발톱", "귀청소", "눈물자국", "털빠짐", "환절기",
        "산책", "운동", "체중", "살이",
        // 행동 교정/훈련 관련
        "물어", "깨물", "입질", "짖", "짖어", "짖는",
        "분리불안", "혼자두면", "혼자 두면",
...
export function detectEmergencyKeywords(message: string): {
    ...
    const emergencyPatterns = [
        ...
        "자일리톨", "초콜릿", "타이레놀", "아세트아미노펜", "이부프로펜",
        "포도", "양파", "마늘",
        "오줌못", "소변못", "소변을못", "오줌을못",
    ];

    const urgentPatterns = [
        "구토", "토했", "토하", "토만", "토를", "토해", "계속토",
        "설사", "피가섞", "혈변",
        "밥안먹", "안먹어", "안먹고", "밥을안", "물을안", "물안먹",
        "식욕없", "식욕이없", "먹질않",
        "이틀째", "3일째", "며칠째", "몇일째", "사흘째",
        "열이", "뜨거", "고열",
        "눈꼽", "눈곱", "눈물이많", "눈이부",
