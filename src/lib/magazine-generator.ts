...
## 출력 형식 (반드시 이 JSON 구조로)
{
  ...
  "content": "HTML 본문 (<h2>, <h3>, <p>, <ul>, <li>, <strong> 태그 활용. 1000~1500자 분량. 3~4개 소제목으로 구성)",
  "tags": ["태그1", "태그2", "태그3", "태그4"],
  "readTime": "N분"
}

## 본문 구성 가이드
1. 도입부: 독자의 공감을 끌어내는 상황 묘사 (1~2문장)
2. 본론: 3~4개 소제목(<h2>)으로 나눠 실용적 정보 전달
3. 마무리: 따뜻한 한 줄 메시지로 마무리${avoidClause}`;
}
