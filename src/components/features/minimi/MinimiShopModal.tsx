...
export default function MinimiShopModal({
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center">
            ...
            <div
                className="relative w-[calc(100%-2rem)] sm:max-w-2xl bg-white dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden max-h-[60vh] sm:max-h-[85vh] flex flex-col"
                role="dialog"
                aria-modal="true"
