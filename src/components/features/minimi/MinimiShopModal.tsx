...
export default function MinimiShopModal({
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center">
            ...
            <div
                className="relative w-full sm:max-w-2xl sm:mx-4 bg-white dark:bg-gray-900 rounded-t-2xl sm:rounded-2xl shadow-2xl overflow-hidden max-h-[55vh] sm:max-h-[85vh] flex flex-col mb-[68px] sm:mb-0"
                role="dialog"
                aria-modal="true"
