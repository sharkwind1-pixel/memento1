                        ...
                        >
                            <CardHeader className="p-0 overflow-hidden">
                                {src ? (
                                    ...
                                    <div className="w-full aspect-[4/3] bg-gradient-to-br from-memento-100 to-memento-200 dark:from-sky-900 dark:to-blue-900 flex items-center justify-center">
                            ...
                            <CardFooter className="flex-col items-start gap-2 p-4">
                                <div className="flex justify-between items-start w-full">
                                    <Badge
                                        variant="outline"
                                        className="bg-memento-100 dark:bg-sky-900/50 border-sky-200 dark:border-memento-700 text-memento-700 dark:text-sky-300 rounded-lg"
                                    >
                                        {pet.badge}
                                    </Badge>
