...
export function middleware(request: NextRequest) {
    ...
    const csp = [
        ...
        "font-src 'self'",
        "worker-src 'self'",
        "connect-src 'self' blob: data: *.supabase.co wss://*.supabase.co *.supabase.in api.openai.com apis.data.go.kr dog.ceo api.thecatapi.com *.push.services.mozilla.com fcm.googleapis.com *.fal.ai *.fal.media https://*.iamport.co https://*.iamport.kr https://*.portone.io https://*.kcp.co.kr https://pay.kcp.co.kr https://*.kakao.com",
