    ...
    return (
        <html lang="ko" suppressHydrationWarning>
                        ...
                        __html: JSON.stringify({
                            ...
                            "@graph": [
                                ...
                                },
                                {
                                    ...
                                    "operatingSystem": "Web",
                                    "description": "반려동물과 함께하는 모든 순간을 기록하고, AI 펫톡으로 맞춤 케어를 받는 메모리얼 커뮤니티 플랫폼",
                                    "offers": [
                                        {
                                            "@type": "Offer",
                                            "name": "베이직 플랜",
            ...
            <body className="font-sans">
                ...
                <footer className="border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-xs text-gray-500 dark:text-gray-400 py-6 px-4 pb-[calc(env(safe-area-inset-bottom)+100px)] xl:pb-6 xl:ml-[420px]">
