...
export const FURNITURE_CATALOG: FurnitureItem[] = [
    // -- 소품 (accessory) --
    {
        ...
        name: "밥그릇 세트",
        category: "accessory",
        imageUrl: "/icons/furniture/pet_bowl.png?v=2",
        price: 60,
    ...
    // -- 가구 (furniture) --
    {
        ...
        name: "동글 방석",
        category: "furniture",
        imageUrl: "/icons/furniture/pet_bed_round.png?v=2",
        price: 120,
    ...
    },
    {
        ...
        name: "납작 쿠션",
        category: "furniture",
        imageUrl: "/icons/furniture/pet_cushion_flat.png?v=2",
        price: 100,
    ...
    },
    {
        ...
        name: "캣타워",
        category: "furniture",
        imageUrl: "/icons/furniture/cat_tower.png?v=2",
        price: 180,
    ...
    },
    {
        ...
        name: "강아지집",
        category: "furniture",
        imageUrl: "/icons/furniture/dog_house.png?v=2",
        price: 150,
    ...
    },
    {
        ...
        name: "민트 소파",
        category: "furniture",
        imageUrl: "/icons/furniture/sofa_mint.png?v=2",
        price: 160,
    ...
    },
    {
        ...
        name: "우주 방석",
        category: "furniture",
        imageUrl: "/icons/furniture/galaxy_bed.png?v=2",
        price: 200,
    ...
    },
    {
        ...
        name: "담요 바구니",
        category: "furniture",
        imageUrl: "/icons/furniture/blanket_basket.png?v=2",
        price: 130,
    ...
    // -- 소품 (accessory) 추가 --
    {
        ...
        name: "다육이 화분",
        category: "accessory",
        imageUrl: "/icons/furniture/succulent_pot.png?v=2",
        price: 50,
    ...
    },
    {
        ...
        name: "간식 항아리",
        category: "accessory",
        imageUrl: "/icons/furniture/treat_jar.png?v=2",
        price: 70,
    ...
    //     name: "아치 창문",
    //     category: "window",
    //     imageUrl: "/icons/furniture/arch_window.png?v=2",
    //     price: 120,
...
export function findFurnitureOrFallback(slug: string): FurnitureItem {
    return findFurniture(slug) ?? {
        ...
        category: "accessory",
        imageUrl: `/icons/furniture/${slug}.png?v=2`,
        price: 100,
        description: "",
    };
}
